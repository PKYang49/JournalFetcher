...
- appraisals: claude -p with Opus 5 (latest Opus; verified reachable on the
  subscription CLI. Pricing/tokenizer not yet re-verified vs 4.8 — see
  AGENTS.md model table.)
